...
import com.dku.council.danfestatable.global.error.exception.CannotSendMMSException;
import com.dku.council.danfestatable.infra.nhn.global.exception.UnexpectedResponseException;
import com.dku.council.danfestatable.infra.nhn.sms.model.dto.request.RequestNHNCloudMMS;
import com.dku.council.danfestatable.infra.nhn.sms.model.dto.request.RequestNHNCloudSMS;
import com.dku.council.danfestatable.infra.nhn.sms.model.dto.response.ResponseNHNCloudMMS;
import com.dku.council.danfestatable.infra.nhn.sms.model.dto.response.ResponseNHNCloudMMS.Body.Data;
import com.dku.council.danfestatable.infra.nhn.sms.model.dto.response.ResponseNHNCloudMMS.Body.Data.SendResult;
    ...
    public void sendMMS(String title, String phone, String body) {
        ...
        try{
            response = webClient.post()
                    ...
                    .body(Mono.just(request), RequestNHNCloudMMS.class)
                    .retrieve()
